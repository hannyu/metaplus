...
public class MetaplusPatch extends MetaplusDoc {
    ...
    public MetaplusPatch(PatchType patchType, String domain, String name) {
        this(patchType, "", domain, name);
    }

    public MetaplusPatch(PatchType patchType, String corp, String domain, String name) {
        super(corp, domain, name);
        init(patchType);
    }

    public MetaplusPatch(PatchType patchType, String fqmn) {
        super(fqmn);
        init(patchType);
    }
    ...
    public static MetaplusPatch copyOf(PatchType patchType, MetaplusDoc doc) {
        if (null == patchType) throw new IllegalArgumentException("patchType can not be null");
        if (null == doc) throw new IllegalArgumentException("Doc can not be null");

        MetaplusPatch patch = new MetaplusPatch(patchType, doc.getFqmnCorp(), doc.getFqmnDomain(), doc.getFqmnName());
